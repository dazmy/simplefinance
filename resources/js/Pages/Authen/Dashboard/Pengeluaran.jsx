...
export default function pengeluaran({ auth, spendings, user }) {
    ...
    return (
        <Authen auth={auth}>
            <div class="w-full mt-6">
                            ...
                            {spendings &&
                                spendings.map((spending, index) => (
                                    ...
                                    >
                                        ...
                                        <td class="py-4 px-6 border-b border-grey-light">
                                            {spending.tanggal_pengeluaran}
                                        </td>
                                        <td class="py-4 px-6 border-b border-grey-light">
                                            {spending.keterangan_pengeluaran}
                                        </td>
                                        <td class="py-4 px-6 border-b border-grey-light">
                                            {spending.jumlah_pengeluaran.toLocaleString(
                                                "id-ID"
                                            )}
                                        </td>
                                        <td
                                        ...
                                        >
                                            <a
                                                href={route(
                                                    "admin.dashboard.pengeluaran.edit",
                                                    spending.slug
                                                )}
                                            >
                                                <button
                                            ...
                                            <div
                                                ...
                                                onClick={() => {
                                                    confirm("Mau dihapus?")
                                                        ? destroy(
                                                              route(
                                                                  "admin.dashboard.pengeluaran.destroy",
                                                                  spending.id
                                                              )
                                                          )
                                                        : false;
                ...
                {pathname == "/dashboard/data/pengeluaran/lastreport" && (
                    <div className="my-4">
                        <a
